...
namespace PetClinicProject.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=PetClinic;Trusted_Connection=True;TrustServerCertificate=true;Encrypt=false;Connect Timeout=30;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ActivityLog>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Activity__3214EC07730C0835");
        ...
        {
            entity.HasKey(e => e.AppointmentId).HasName("PK__Appointm__8ECDFCC2DA93DF92");
        ...
        {
            entity.HasKey(e => e.BillId).HasName("PK__Billing__11F2FC6AF804FC99");
        ...
        {
            entity.HasKey(e => e.BillingDetailId).HasName("PK__BillingD__77F5CC2449A315CA");
        ...
        {
            entity.HasKey(e => e.ConsultationId).HasName("PK__Consulta__5D014A986FE7C6A7");
        ...
        {
            entity.HasKey(e => e.ConsultationTreatmentId).HasName("PK__Consulta__F92DEA6C9042631D");
        ...
        {
            entity.HasKey(e => e.TestId).HasName("PK__Diagnost__8CC33160B378D19A");
        ...
        {
            entity.HasKey(e => e.OwnerId).HasName("PK__Owners__819385B8F6D87C6E");
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patients__970EC3666097ED6D");
        ...
        {
            entity.HasKey(e => e.PrescriptionId).HasName("PK__Prescrip__4013083202C8040E");
        ...
        {
            entity.HasKey(e => e.TreatmentId).HasName("PK__Treatmen__1A57B7F1C1B7AA74");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4CE9D65E78");
        ...
        {
            entity.HasKey(e => e.VaccineId).HasName("PK__Vaccinat__45DC68896DB5DE1A");
        ...
        {
            entity.HasKey(e => e.RecordId).HasName("PK__VaccineR__FBDF78E964314582");
